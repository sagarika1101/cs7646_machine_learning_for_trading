...
def SMA(normed_prices, start_date = dt.datetime(2008,1,1), end_date = dt.datetime(2009,12,31),plot=False):
...
def Bollinger_Bands(normed_prices, start_date = dt.datetime(2008,1,1), end_date = dt.datetime(2009,12,31),plot=False):
	#calculate SMA with window size 20
	SMA = normed_prices.rolling(window=20,center=False).mean()
	SMA = SMA.bfill()
...
def CCI(normed_prices, start_date = dt.datetime(2008,1,1), end_date = dt.datetime(2009,12,31),plot=False):
	#calculate SMA with window size 20
	SMA = normed_prices.rolling(window=20,center=False).mean()
	SMA = SMA.bfill()
...
def momentum(normed_prices, start_date = dt.datetime(2008,1,1), end_date = dt.datetime(2009,12,31),plot=False):
